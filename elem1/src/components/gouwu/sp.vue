...
" :style="'color:#'+arr1.icon_color+';'+'border:1px solid #'+arr1.icon_color" class="new2">{{arr1.icon_name}}</span>
					...
					<div>
						<div v-if="arr.specfoods.length==1" class="gou2" @click="add1(datas.length,data.foods.length,index1,index,$event)">
							<img src="./img/4.png" alt="" />
						</div>
						<div class="gou3" v-if="arr.specfoods.length==1">
							<img src="./img/5.png" alt="" @click="jian1(index,$event)" />
							<span class="gou4" v-if="arr1[index]">{{arr1[index]}}</span>
						</div>
					</div>
					<div style="position: relative;">
						<div v-if="arr.specfoods.length>1" class="gou1" @click="add2">
							选规格
						</div>
						<div class="maskx" @click="xiaoshi">
							<div class="mask">
								<div class="mask0">
									...
									<div class="mask1">
										<span v-for="(price,index) in arr.specfoods" @click="qian(price.price,$event)" class="change">
										{{price.specs_name}}
									</span>
									</div>
									<div class="mask4">
  ...
  <div class="sp">
          ...
          <div class="left1">
            <ul class="left">
              <li v-for="(data,index) in datas" @click="bai(index,$event)" class="li1" data="index">
                ...
                <img :src='`https://fuss10.elemecdn.com/${data.icon_url}.jpeg`' alt="">
    ...
    <div class="right">
      ...
      <ul v-for="(data,index) in datas" class="uls">
        <div class="divh">
          <span class="span1">{{data.name}}</span>
          <span class="span2">{{data.description}}</span>
          <span class="span3">...</span>
...
" :style="'color:#'+arr1.icon_color+';'+'border:1px solid #'+arr1.icon_color" class="new2">{{arr1.icon_name}}</span>
          ...
          <div v-if="arr.specfoods.length>1" class="gou1">
            选规格
            <div class="mask">
              <div class="mask0">
                <div class="mask2">
                ...
                <div class="mask1">
                  <div v-for="(price,index) in arr.specfoods">
                    {{price.specs_name}}
                  </div>
                </div>
                <div class="mask4">
